	...
	return (
		...
		>
			...
			<div className="relative z-10 w-full max-w-4xl">
				...
				<div className="mt-6 text-2xl leading-9 text-gray-400">
					BluuPay empowers businesses to sell smarter, manage inventory in real time, and gain actionable insights into
					performance—all from a unified, cloud-based platform that works seamlessly across desktop, tablet, and mobile
					devices.
				</div>
