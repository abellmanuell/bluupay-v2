...
import ImpressionsWidgetType from "../../../api/types/ImpressionsWidgetType";
...
function Impressions() {
  ...
  const { data: widget } = useGetWidget<ImpressionsWidgetType>("impressions");

  // Always have safe data
