...
import AgeWidgetModelType from "../../../api/types/AgeWidgetType";
import ReactApexChart from "react-apexcharts";

/**
 * Default widget values (fallback).
 */
const defaultWidget: AgeWidgetModelType = {
  series: [60, 40],
  labels: ["18-35", "36+"],
  uniqueVisitors: 1000,
};
...
function AgeWidget() {
  ...
  const { data: widget } = useGetWidget<AgeWidgetModelType>("age");

  // Use widget if available, otherwise defaultWidget
